...
class SimulatedAnnealing 
{
    ...
    // Generate the initial candidate such that it does not contain conflicts in blocks
    ...
    // Energy level of a candidate is defined by number of conflicts it has
    ...
    // Recursive function that refines the candidate from initial state to goal state
